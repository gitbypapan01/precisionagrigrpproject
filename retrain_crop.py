...
def retrain():
    ...
    print("Training RandomForestClassifier locally...")
    ...
    print("Retraining completed successfully! crop.pkl is now compatible with scikit-learn 1.4.0.")
